...
const KidsValueComponent = () => {
    return (
        <div className="min-h-auto relative mx-0 flex w-full flex-col items-center justify-center gap-y-3 px-8 py-[4.5em] lg:flex-row-reverse">
            <div className="flex basis-1/2 flex-col gap-y-8">
                <TitleComponent title="Create profiles for kids." />
                <SubtitleComponent
                    isSmall={false}
